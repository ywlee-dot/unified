...
import { Upload, Play, Loader2, CheckCircle, XCircle, Download, FileText } from 'lucide-react';
    ...
    <div className="p-6 max-w-2xl">
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm" style={{ color: '#8B95A1' }}>
          사례 데이터를 업로드하고 보고서 생성 워크플로를 실행하세요
        </p>
      </div>
      ...
      >
        ...
        >
          <div
            ...
            style={{ backgroundColor: '#fef3c7' }}
          >
            <Upload className="h-5 w-5" style={{ color: '#F59E0B' }} />
          </div>
